...
public final class LoadArrays {
	 ...
	 * @param data
	 *                (first dim is line no, second is variable number,
	 *                content is value no for variable k in
	 *                [0,nValuesForAttribute[k])
	 */
	public static ChordalysisModeller.Data makeModelData(int[] nValuesForAttribute, int[][] data) {
		...
		// --- 3 ---
		// Create the data:
		return new ChordalysisModeller.Data(new DecomposableModel(variables, nValuesForAttribute),
